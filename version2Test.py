...
from version2 import BasicLexer, BasicParser, Interpreter
...
class MathOpsTest(unittest.TestCase):
    ...
    def test_add(self):
        ...
        result = self.p.parse(self.l.tokenize(data))[0]
        self.assertEqual(result, expected)
        result1 = self.p.parse(self.l.tokenize(data1))[0]
        self.assertEqual(result1, expected1)
        result2 = self.p.parse(self.l.tokenize(data2))[0]
